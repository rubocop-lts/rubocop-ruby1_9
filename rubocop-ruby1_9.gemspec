...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rubocop/ruby1_9/version.rb", mod) }::Rubocop::Ruby19::Version::VERSION
  spec.authors = ["Peter H. Boling", "Annibelle Boling"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "🦾 Rules for Rubies: Rubocop + Standard + Betterlint + Gradual"
  spec.description = "🦾 Configure RuboCop + a bevy of friends to gradually lint Ruby 1.9 code"
  ...
  spec.metadata["homepage_uri"] = "https://rubocop-ruby1-9.galtzo.com"
  ...
  # The 'git' gem is optional; rubocop-ruby1_9 falls back to shelling out to `git` if it is not present.
