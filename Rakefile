...
# rubocop-ruby1_9 Rakefile v7.0.0 - 2026-06-07
...
# rake install                                # Build and install rubocop-ruby1_9-1.0.0.gem in...
# rake install:local                          # Build and install rubocop-ruby1_9-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template rubocop-ruby1_9 against itse...
